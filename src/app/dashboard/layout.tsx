...
const NavLink = ({ href, icon: Icon, children, collapsed }: any) => (
    <Link href={href} className="flex items-center px-4 py-2.5 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors font-medium">
...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen w-full bg-gray-100 dark:bg-gray-900">
      <aside className={`bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300 ${collapsed ? 'w-20' : 'w-72'}`}>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
            <NavLink href="/dashboard" icon={NewspaperIcon} collapsed={collapsed}>Dashboard</NavLink>
            ...
            <NavLink href="#" icon={MegaphoneIcon} collapsed={collapsed}>Marketing</NavLink>
            <NavLink href="#" icon={TargetIcon} collapsed={collapsed}>Metas do time</NavLink>
            <NavLink href="#" icon={FolderIcon} collapsed={collapsed}>Material de apoio</NavLink>
