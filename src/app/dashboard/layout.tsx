...
export default function DashboardLayout({
  ...
  type UserDataWithPerms = typeof userData & { permissoes?: { admin?: boolean; developer?: boolean; locacao?: boolean; ayra?: boolean } };
  ...
  // Ayra (pré-lançamento Nox × Santer): quem tem Desenvolvedor já vê; os
  // demais, com a tag "Ayra" ligada na área do desenvolvedor
  const isAyraUser = podeVerAyra(userDataWithPerms);
  ...
  const navGroups: { titulo: string | null; itens: NavItem[] }[] = [
    ...
    { titulo: 'Vendas', itens: [
      // Ayra fica ACIMA do CRM — pedido do gestor
      ...(isAyraUser ? [{ href: '/dashboard/ayra', icon: SparklesIcon, label: 'Ayra', cor: 'text-[#E8CF8A]' }] : []),
