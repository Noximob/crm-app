...
export default function RelatoriosPage() {
  ...
  const [aba, setAba] = useState<'corretor' | 'propaganda'>('corretor');
  ...
  // rodízio no dossiê do corretor: SEMPRE o histórico todo — o período corta depois
    ...
    <div className="max-w-6xl mx-auto px-3 sm:px-4 pb-16 pt-6 space-y-4">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap rounded-xl border border-white/10 bg-white/[0.04] p-1 gap-1 self-start">
          {([['corretor', '👤 Análise do corretor'], ['propaganda', '📣 Análise de propaganda']] as const).map(([id, label]) => (
