...
const adminCategories = [
  ...
  },
  {
    ...
    items: [
      { title: 'Setor de Locação', icon: '🔑', description: 'A esteira do aluguel: imóveis, interessados, contratos com vistoria, financeiro com repasse — e o portal do cliente em /portal', href: '/dashboard/admin/locacao' },
