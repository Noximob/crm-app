...
export default function MateriaisConstrutoraAdminPage() {
  ...
  const handleAddImovel = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formImovel.nome.trim() || !formImovel.endereco.trim() || !formImovel.valor) return;
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-[#23283A] rounded-2xl p-6 shadow-soft border border-[#E8E9F1] dark:border-[#23283A] sticky top-6">
                ...
                <form onSubmit={handleAddImovel} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-[#6B6F76] dark:text-gray-300 mb-2">Localização (Google Maps)</label>
                    <input
                      type="url"
