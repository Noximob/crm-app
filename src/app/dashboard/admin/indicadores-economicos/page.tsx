    ...
    <div className="bg-[#F5F6FA] dark:bg-[#181C23] min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-[#23283A] rounded-2xl shadow-soft border border-[#E8E9F1] dark:border-[#23283A] p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#F5F6FA] dark:bg-[#181C23] border border-[#E8E9F1] dark:border-[#23283A] rounded-lg text-[#2E2F38] dark:text-white placeholder-[#6B6F76] dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#D4A017] transition-all"
              />
          ...
          <div className="mt-8 p-4 bg-[#F0F4FF] dark:bg-[#23283A] rounded-xl border border-[#E8C547]/20">
          ...
          <div className="flex gap-4 mt-8 pt-6 border-t border-[#E8E9F1] dark:border-[#23283A]">
            <button
              onClick={handleSave}
              disabled={saving}
              className="px-8 py-3 bg-[#D4A017] hover:bg-[#B8860B] disabled:bg-[#6B6F76] disabled:cursor-not-allowed text-white rounded-lg font-semibold transition-colors flex items-center gap-2"
            >
              {saving ? (
                <>
