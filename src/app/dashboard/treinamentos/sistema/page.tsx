      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-4 mb-4">
            <h1 className="al-display text-2xl font-bold text-white uppercase tracking-[0.14em]">Treinamento do Sistema</h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {materiaisFiltrados.map((material) => (
            <div key={material.id} className="bg-white/[0.03] border border-white/[0.08] rounded-2xl overflow-hidden hover:border-[#9F6BFF]/40 hover:-translate-y-0.5 transition-all duration-200 group">
              {/* Thumbnail */}
              <div className="relative h-48 bg-gradient-to-br from-[#9F6BFF]/25 to-[#12101a] flex items-center justify-center">
              ...
              {/* Conteúdo */}
              <div className="p-6">
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#C4A6FF] transition-colors">
                  {material.titulo}
                </h3>
