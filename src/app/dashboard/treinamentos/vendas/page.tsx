  ...
  return (
    <div className="min-h-full py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="al-display text-2xl font-bold text-white uppercase tracking-[0.14em] mb-2">Vendas</h1>
          <p className="text-text-secondary">Técnicas, estratégias e dicas para aumentar sua conversão e fechar mais vendas</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Nenhum treinamento de vendas disponível</h2>
          ...
          <div className="space-y-8">
            ...
            {pdfs.length > 0 && (
              <div>
                <h2 className="al-display text-[15px] font-bold text-white uppercase tracking-[0.14em] mb-4 flex items-center gap-2">
                  <FileIcon className="h-6 w-6 text-[#FF5C7E] drop-shadow-[0_0_8px_rgba(255,30,86,0.5)]" />
                  Materiais em PDF
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {pdfs.map((treinamento) => (
                    <div
                      key={treinamento.id}
                      className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-[#FF1E56]/40 hover:-translate-y-0.5 transition-all duration-200"
                    >
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-12 bg-[#FF1E56]/10 border border-[#FF1E56]/30 rounded-lg flex items-center justify-center">
                          <FileIcon className="h-6 w-6 text-[#FF5C7E] drop-shadow-[0_0_8px_rgba(255,30,86,0.5)]" />
          </div>
                        <div>
            ...
            {videos.length > 0 && (
              <div>
                <h2 className="al-display text-[15px] font-bold text-white uppercase tracking-[0.14em] mb-4 flex items-center gap-2">
                  <PlayIcon className="h-6 w-6 text-[#FF5C7E] drop-shadow-[0_0_8px_rgba(255,30,86,0.5)]" />
                  Vídeos
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {videos.map((treinamento) => {
                    ...
                    return (
                      <div
                        key={treinamento.id}
                        className="bg-white/[0.03] border border-white/[0.08] rounded-xl overflow-hidden hover:border-[#FF1E56]/40 hover:-translate-y-0.5 transition-all duration-200"
                      >
                        {embedUrl ? (
