  ...
  return (
    <div className="min-h-full py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="al-display text-2xl font-bold text-white uppercase tracking-[0.14em] mb-2">Mercado</h1>
          <p className="text-text-secondary">Análises de mercado, tendências e insights sobre o setor imobiliário</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Nenhum treinamento de mercado disponível</h2>
          ...
          <div className="space-y-8">
            ...
            {pdfs.length > 0 && (
              <div>
                <h2 className="al-display text-[15px] font-bold text-white uppercase tracking-[0.14em] mb-4 flex items-center gap-2">
                  <FileIcon className="h-6 w-6 text-[#C4A6FF] drop-shadow-[0_0_8px_rgba(159,107,255,0.5)]" />
                  Materiais em PDF
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {pdfs.map((treinamento) => (
                    <div
                      key={treinamento.id}
                      className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-6 hover:border-[#9F6BFF]/40 hover:-translate-y-0.5 transition-all duration-200"
                    >
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-12 bg-[#9F6BFF]/10 border border-[#9F6BFF]/30 rounded-lg flex items-center justify-center">
                          <FileIcon className="h-6 w-6 text-[#C4A6FF] drop-shadow-[0_0_8px_rgba(159,107,255,0.5)]" />
                        </div>
                        <div>
            ...
            {videos.length > 0 && (
              <div>
                <h2 className="al-display text-[15px] font-bold text-white uppercase tracking-[0.14em] mb-4 flex items-center gap-2">
                  <PlayIcon className="h-6 w-6 text-[#C4A6FF] drop-shadow-[0_0_8px_rgba(159,107,255,0.5)]" />
                  Vídeos
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {videos.map((treinamento) => {
                    ...
                    return (
                      <div
                        key={treinamento.id}
                        className="bg-white/[0.03] border border-white/[0.08] rounded-xl overflow-hidden hover:border-[#9F6BFF]/40 hover:-translate-y-0.5 transition-all duration-200"
                      >
                        {embedUrl ? (
