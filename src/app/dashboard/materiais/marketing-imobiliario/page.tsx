...
export default function MarketingImobiliarioMateriaisPage() {
  ...
  const handleDownload = (material: MaterialMarketing) => {
    if (material.url) {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-[#6B6F76] dark:text-gray-300 text-base">
            Confira os materiais de marketing produzidos pela imobiliária para uso da equipe.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-[#6B6F76] dark:text-gray-300">
              Os materiais de marketing aparecerão aqui quando forem cadastrados pelo administrador.
            </p>
          </div>
        ) : (
