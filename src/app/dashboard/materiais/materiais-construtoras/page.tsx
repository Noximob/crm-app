                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      {construtora.logoUrl ? (
                        ...
                        <div className="w-12 h-12 bg-gradient-to-br from-[#D4A017] to-[#E8C547] rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                          <BuildingIcon className="h-6 w-6 text-white" />
                        </div>
                      )}
                      <div>
                        <h3 className="font-bold text-[#2E2F38] dark:text-white text-lg group-hover:text-[#D4A017] transition-colors">
                          {construtora.nome}
                        </h3>
                    ...
                    <div className="flex items-center justify-between text-xs text-[#6B6F76] dark:text-gray-300">
                      ...
                      <span className="bg-[#D4A017]/10 text-[#D4A017] px-2 py-1 rounded-full">Ver</span>
                    </div>
                  </div>
                ))}
              </div>
                      ...
                      {getGroupedMateriais().links.map(material => (
                        ...
                        >
                          <div className="flex items-center gap-3 mb-2">
                            <div className="w-8 h-8 bg-gradient-to-br from-[#D4A017] to-[#E8C547] rounded-lg flex items-center justify-center flex-shrink-0">
                          ...
                          <div className="flex gap-2">
                            {material.url && (
                              <a
                                ...
                                className="flex-1 px-3 py-1.5 bg-[#D4A017] hover:bg-[#B8860B] text-white text-xs rounded-lg transition-colors font-semibold text-center"
                              >
                                Acessar Link
                              </a>
                            )}
                          ...
                          <div className="flex gap-2">
                            {material.url && (
                              <button
                                ...
                                className="flex-1 px-3 py-1.5 bg-[#D4A017] hover:bg-[#B8860B] text-white text-xs rounded-lg transition-colors font-semibold"
                              >
                              ...
                              <>
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 opacity-0 group-hover:opacity-100 transition-opacity">
                                  <div className="w-12 h-12 bg-white bg-opacity-90 rounded-full flex items-center justify-center">
                                    <VideoIcon className="h-6 w-6 text-[#D4A017]" />
                                  </div>
                                </div>
                              </>
                            ) : null}
                          ...
                          <div className="text-center">
                            ...
                            {material.url && (
                              <button
                                onClick={() => handleDownload(material)}
                                disabled={downloadingId === material.id}
                                className="w-full mt-2 px-2 py-1 bg-[#D4A017] hover:bg-[#B8860B] text-white text-xs rounded transition-colors font-semibold"
                              >
                                {downloadingId === material.id ? (
                                  <span className="flex items-center gap-2"><SpinnerIcon /> Baixando...</span>
                                ) : 'Download'}
                        ...
                        <div key={index} className="bg-white dark:bg-[#23283A] rounded-xl p-4 border border-[#E8E9F1] dark:border-[#23283A] flex flex-col items-center">
                          ...
                          <div className="space-y-2 w-full">
                            ...
                            <button
                              ...
                              className="w-full px-4 py-2 bg-[#D4A017] hover:bg-[#B8860B] disabled:bg-[#6B6F76] disabled:cursor-not-allowed text-white rounded-lg transition-colors font-semibold text-sm"
                            >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-[#23283A] rounded-2xl p-6 border border-[#E8E9F1] dark:border-[#23283A]">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      <svg className="h-5 w-5 text-[#D4A017]" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
