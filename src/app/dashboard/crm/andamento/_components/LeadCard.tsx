...
// Cartão do kanban — quadro é SÓ leitura (o circuito move os leads sozinho).
// Card inteiro clicável abre o lead; WhatsApp e +Info param a propagação.
export default function LeadCard({ lead, corEtapa }: { lead: Lead; corEtapa?: string }) {
  ...
  return (
    <div
      ...
      className="relative overflow-hidden cursor-pointer bg-white/[0.04] border border-white/[0.08] rounded-xl p-2.5 hover:border-[#FF1E56]/40 hover:-translate-y-0.5 hover:shadow-[0_10px_24px_-10px_rgba(255,30,86,0.35)] transition-all duration-200 min-h-[60px] flex flex-col gap-1 w-full max-w-[180px] mx-auto"
    >
      <span
      ...
      />
      <div className="font-semibold text-xs text-white truncate mb-1">{lead.nome}</div>
