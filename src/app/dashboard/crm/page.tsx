                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-4">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-64 pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3478F6] focus:border-transparent"
                                />
                                {searchTerm && (
                                    <button
