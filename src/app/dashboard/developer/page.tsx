  ...
  const ChartBarIcon = () => (
    ...
    <div className="max-w-5xl mx-auto py-8 px-4">
      ...
      {selectedImobiliaria && (
        <div className="bg-white rounded-2xl shadow-soft border border-[#E8E9F1] dark:bg-[#23283A] p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              className="ml-auto text-[#6B6F76] dark:text-gray-400 text-xs font-medium hover:text-[#D4A017] dark:hover:text-[#E8C547] p-1 rounded-full transition-colors"
      ...
      <div className="mt-6 space-y-3">
        <button
          className="flex items-center bg-[#D4A017] hover:bg-[#B8860B] text-white font-semibold py-2 px-5 rounded-lg shadow transition-colors"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-[#23283A] rounded-xl p-8 w-full max-w-2xl shadow-lg relative">
            ...
            <form onSubmit={e => { e.preventDefault(); salvarIndicadores(); }}>
              ...
              <button
                type="submit"
                className="mt-6 w-full bg-[#D4A017] hover:bg-[#B8860B] text-white font-semibold py-2 px-6 rounded-lg shadow transition-colors disabled:opacity-60"
