        ...
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href={`mailto:${CONTACT_EMAIL}`} className="p-2 rounded-lg text-text-secondary hover:text-sky-400 hover:bg-white/5 transition-colors" aria-label="E-mail">
      ...
      <section id="contato" className="py-12 px-4 border-t border-white/[0.06]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <a href={`mailto:${CONTACT_EMAIL}`} className="p-3 rounded-xl bg-white/5 border border-white/10 hover:border-sky-400/40 hover:bg-sky-500/10 transition-all" aria-label="E-mail" title={CONTACT_EMAIL}>
